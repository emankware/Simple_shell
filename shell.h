...
#include "lists.h"
/**
 * struct param_s - The structure used to hold all shell variables needed
 * @argv: this the command line argument from main function
 ...
 * @alias_head:its a  singly linked list of aliases
