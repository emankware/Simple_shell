...
/**
 * list_len - this the number of elements in a linked list_t list.
 * @h: the start of list
 *
...
/**
 * get_node - function to search for a node
 * @head: start of list
 * @str: key
...
/**
 * free_list - the function clears a linked list from mem
