...
/**
 * _printf - it outputs text to standard output specified by format
...
/**
 * flush_buffer - function to print out the buffer upto index and reset
...
/**
 * print_arg - function to print argument string
 * @arg: string
 *
...
/**
 * get_type - THe get type from the specifier from format string
